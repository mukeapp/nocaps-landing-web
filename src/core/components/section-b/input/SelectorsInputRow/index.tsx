...
const SelectorsInputRow: React.FC<Props> = ({
  sectorVal, onPickSector,
  focusVal, onPickFocus,
  unitVal, onPickUnit,
  priorityVal, onPickPriority
}) => {
  return (
    <>
      <View style={[MainStyles.viewtwo, { marginTop: hp(2) }]}>
        <View style={MainStyles.newview}>
          ...
          <TouchableOpacity onPress={onPickSector}>
            <TextBox icn={true} wid={50} plac="Select item" top={1} edt={false} val={sectorVal} />
          </TouchableOpacity>
        </View>
        ...
        <View style={MainStyles.newview}>
          ...
          <TouchableOpacity onPress={onPickFocus}>
            <TextBox icn={true} wid={35} plac="Select Item" top={1} edt={false} val={focusVal} />
          </TouchableOpacity>
        </View>
      </View>
      ...
      <View style={[MainStyles.viewtwo, { marginTop: hp(2) }]}>
        <View style={MainStyles.newview}>
          ...
          <TouchableOpacity onPress={onPickUnit}>
            <TextBox icn={true} wid={35} plac="Select item" top={1} edt={false} val={unitVal} />
          </TouchableOpacity>
        </View>
        ...
        <View style={MainStyles.newview}>
          ...
          <TouchableOpacity onPress={onPickPriority}>
            <TextBox icn={true} wid={50} plac="Select Item" top={1} edt={false} val={priorityVal} />
          </TouchableOpacity>
        </View>
      </View>
    </>
...
export default SelectorsInputRow;
