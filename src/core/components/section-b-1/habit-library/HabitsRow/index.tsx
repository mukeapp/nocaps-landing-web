...
const HabitsRow: React.FC<StacksRowProps> = React.memo(
  ({
    ...
    return (
      <FlatList
        data={getHabitDataByCategory(stacks, 2, postHabitId, postHabitLinkId, postHabitLinkItemId, filterByHabitId) as HabitComponent[]}
