...
const HabitLinksRow: React.FC<StacksRowProps> = React.memo(
  ({
    ...
    return (
      <FlatList
        data={getHabitDataByCategory(stacks, 3, postHabitId, postHabitLinkId, postHabitLinkItemId, filterByHabitLinkId) as HabitLinkComponent[]}
