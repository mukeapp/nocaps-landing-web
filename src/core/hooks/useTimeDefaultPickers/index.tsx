...
export default function useTimeDefaultPickers(routeData?: any) {
  const [startDate, setStartDate] = useState<Date | null>(routeData?.startDate || new Date());
  const [endDate, setEndDate] = useState<Date | null>(routeData?.endDate || new Date());
