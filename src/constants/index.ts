...
export const pricingCards = [
    {
        ...
        features: [
            ...
            "Unlimited habitStacks, Habits, HabitLinks & HabitLinksItems",
        ],
        priceId: "",
    },
    {
        title: "Monthly",
        description: "2 Weeks Free Trial, then $15.00/month. Was $20.00 — 30% off.",
        price: "$15.00",
        duration: "month",
    ...
    {
        title: "Yearly",
        description: "$13.33/month, billed annually. Was $190.00 — 40% off.",
        price: "$160.00",
        duration: "year",
