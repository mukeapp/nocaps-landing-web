...
const HeroAppButtons = () => {
    ...
    return (
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-8 w-full">
            <button
                onClick={comingSoon}
                className="flex items-center gap-2 rounded-xl border border-foreground/20 bg-foreground/5 hover:bg-foreground/10 px-5 py-3 text-sm font-medium transition-colors"
            >
