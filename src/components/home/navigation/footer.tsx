        ...
        <footer className="flex flex-col relative items-center justify-center border-t border-border pt-16 pb-8 px-6 lg:px-8 w-full max-w-6xl mx-auto lg:pt-32">
            ...
            <div className="grid gap-8 xl:grid-cols-3 xl:gap-8 w-full">
                ...
                <div className="flex flex-col items-start justify-start md:max-w-[200px]">
                    ...
                    Forge engaging and personalized habit-tracking experiences instantly.
                    </p>
                    ...
                    <div className="md:grid md:grid-cols-2 md:gap-8">
                        ...
                        <div className="mt-10 md:mt-0 flex flex-col">
                            ...
                            <ul className="mt-4 text-sm text-muted-foreground">
                                ...
                                <li className="mt-2">
                                    <Link href="/about/team" className="hover:text-foreground transition-all duration-300">
                                        About the Team
                                    </Link>
                                </li>
                                <li className="mt-2">
            ...
            <div className="mt-8 border-t border-border/40 pt-4 md:pt-8 md:flex md:items-center md:justify-between w-full">
                <p className="text-sm text-muted-foreground mt-8 md:mt-0">
                    &copy; {new Date().getFullYear()} MUKEAPPS LLC. All rights reserved.
                </p>
            </div>
