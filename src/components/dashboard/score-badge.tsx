...
// Mirrors mobile's real tier map (core/utils/utilities/score.ts colorMap):
// gray=UNKNOWN, red=BAD, purple=POOR, orange=AVERAGE, green=GOOD, gold=EXCELLENT.
const TIER_STYLES: Record<string, string> = {
  GRAY: "bg-score-gray/15 text-score-gray",
  RED: "bg-score-red/15 text-score-red",
  PURPLE: "bg-score-purple/15 text-score-purple",
